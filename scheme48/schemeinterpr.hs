...
showVal (Func {params = args, vararg = varargs, body = body, closure = env}) = showFunc args varargs

showFunc :: [String] -> Maybe String -> String
showFunc args varargs =
...
eval env (List (function : args)) = evalFunc env function args
...
evalFunc :: Env -> LispVal -> [LispVal] -> IOThrowsError LispVal
evalFunc env function args = do 
